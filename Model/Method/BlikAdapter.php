...
/**
 * Adapter for payment method using Blik.
 */
class BlikAdapter extends AbstractAdapter
{
    ...
    public function isActive($storeId = null)
    {
        $visibility = $this->scopeConfig->getValue(
            'payment/dotpay_blik/visibility',
    ...
    /**
     * Return SDK configuration object with general information including blik settings.
     *
    ...
    public function getConfiguration()
    {
        ...
        $config->setBlikVisible($this->isActive());
        return $config;
    }
}
