...
/**
 * Adapter for payment method using credit cards with Masterpass
 */
class MpAdapter extends AbstractAdapter
{
    ...
    /**
     * Return SDK configuration object with general information including Masterpass settings.
     *
