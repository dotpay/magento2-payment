...
use Dotpay\Channel\Other;

/**
 * Factory which produces SDK Other channel.
 */
class OtherFactory extends AbstractFactory
{
    /**
     * Return SDK Other channel filled by all necessary data.
     *
    ...
    {
        $channel = new Other($this->paymentAdapter->getConfiguration(),
            $this->getTransaction(),
